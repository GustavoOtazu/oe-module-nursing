...
use OpenEMR\Modules\Nursing\NursingCard;
...
class NursingCardTest extends TestCase
{
    ...
    {
        $this->assertSame('patient/partials/nursing_card.html.twig', $this->makeCard()->getTemplateFile());
    }
    ...
    public function testTemplateVariablesContainModuleBasePath(): void
    {
        $vars = $this->makeCard()->getTemplateVariables();
        $this->assertSame('/interface/modules/custom_modules/oe-module-nursing/public', $vars['moduleBasePath']);
    }
