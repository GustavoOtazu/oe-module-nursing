...
<script type='text/javascript' language='JavaScript'>
    ...
    $(document).on('click', '.vitalsbtn', function() {
        top.RTop.location = "<?php echo text(OEGlobalsBag::getInstance()->getString('webroot')); ?>" + "/interface/patient_file/summary/demographics.php?set_pid=" + $(this).data('pid') + '&goto-vitals=vitals';
    });
