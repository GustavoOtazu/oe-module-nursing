...
<head>
    ...
    <script>
        function cancelClicked() {
            top.RTop.location = <?php echo js_escape($web_root . '/interface/modules/custom_modules/oe-module-nursing/public/dashboard/lista_internados.php'); ?>;
            return false;
        }
    </script>
</head>
...
<div id="container_div" class="<?php echo attr($oemr_ui->oeContainer()); ?>">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form method="post" action="<?php echo $web_root; ?>/interface/modules/custom_modules/oe-module-nursing/public/dashboard/save_internado.php">
