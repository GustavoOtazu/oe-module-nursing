...
/** @var list<array<string, string|int|null>> $inpatient */
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            window.setpatient = function(pid, lname, fname, dob) {
                top.restoreSession();
                top.RTop.location = webroot_url + '/interface/modules/custom_modules/oe-module-nursing/public/dashboard/editar_internado.php?pid=' + encodeURIComponent(pid);
            };
            ...
            $(document).on('click', '.btn-editar', function() {
                top.RTop.location = webroot_url + '/interface/modules/custom_modules/oe-module-nursing/public/dashboard/editar_internado.php?id=' + $(this).data('id');
            });
