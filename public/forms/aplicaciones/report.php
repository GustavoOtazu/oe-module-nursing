...
function aplicaciones_report(int $pid, int $encounter, int $cols, int $id): void
{
    // Adds "Print" next to "Delete" in the encounter form list (see EncounterFormButtons).
    \OpenEMR\Modules\Nursing\EncounterFormButtons::render('aplicaciones', 'Nursing Applications', (int) $pid, (int) $encounter, (int) $id);
