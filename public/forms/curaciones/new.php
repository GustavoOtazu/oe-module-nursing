...
if ($is_edit && \OpenEMR\Modules\Nursing\FormLock::isLocked('curaciones', $id, $encounter)) {
...
<div class="container-fluid mt-3">
    ...
    <form method="POST" action="<?php echo attr($save_url); ?>" id="formCuraciones" onsubmit="top.restoreSession();">
